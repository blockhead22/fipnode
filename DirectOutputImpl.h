...
public:
    ...
    HRESULT AddPage(void* hDevice, DWORD dwPage, DWORD dwFlags);
	HRESULT RemovePage(void* hDevice, DWORD dwPage);
	HRESULT SetLed(void* hDevice, DWORD dwPage, DWORD dwIndex, DWORD dwValue);
	HRESULT SetString(void* hDevice, DWORD dwPage, DWORD dwLine, DWORD cchLength, const wchar_t* wszString);
...
private:
	...
	bool GetDirectOutputFilename(wchar_t* filename, DWORD length);
